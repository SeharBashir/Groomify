...
// // //           // ✅ Filter Spa Services
// // //           const spaServices = servicesArray.filter(
// // //             (service) =>
// // //               service.serviceName &&
// // //               service.serviceName.trim().toLowerCase().includes('spa')
// // //           );
...
// // //         />
// // //       ) : (
// // //         <Text style={styles.emptyMessage}>No Spa services available.</Text>
// // //       )}
// // //     </View>
// // //   );
// // // };
      ...
      (snapshot) => {
        if (snapshot.exists()) {
          ...
          const spaServices = servicesArray.filter(
            (service) =>
              service.serviceName &&
              service.serviceName.trim().toLowerCase() === 'spa'
          );
