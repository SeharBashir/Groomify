...
//           // ✅ Filter Massage Services (case-insensitive)
...
//         if (!matchedSalon) return false; // Skip if no matching salon found

//         // Filter based on selected filter
//         if (selectedFilter === 'All') {
//           return true; // Show all massage services
...
//           ownerId: matchedSalon.ownerId, // Ensure ownerId is included
//         };
//       });
//   }, [services, salons, selectedFilter]); // ✅ Dependencies include services, salons, and selectedFilter
...
//       </TouchableOpacity>
//       <Text style={styles.header}>Male Massage Services</Text>
...
//         />
//       ) : (
//         <Text style={styles.emptyMessage}>No Male Massage services available.</Text>
//       )}
//     </View>
//   );
// };
...
//           salonType: salon ? salon.salonType : null,
...
//         <ActivityIndicator size="large" color="#00665C" style={{ marginTop: 20 }} />
//       ) : error ? (
//         <Text style={styles.emptyMessage}>Error: {error}</Text>
//       ) : updatedServices.length > 0 ? (
//         <FlatList
//           data={updatedServices}
//           renderItem={renderServiceItem}
...
const MaleMassage = () => {
  ...
  const handleBooking = (item) => {
    ...
    saveUserAction(uid, item.id, item.serviceName, "Massage", "booked", 10);
