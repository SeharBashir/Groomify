...
// //   const renderServiceItem = ({ item }) => (
// //     <TouchableOpacity
// //       onPress={() => navigation.navigate('ServiceDetails', { service: item })} // Navigate to ServiceDetails
// //     >
...
// //           keyExtractor={(item) => item.id}
// //           ListEmptyComponent={
// //             <Text style={styles.emptyMessage}>No services added yet for this salon.</Text>
// //           }
// //         />
// //       )}
// //     </View>
...
// //   imagePlaceholder: { // Style for placeholder
// //     width: '100%',
// //     height: 180,
// //     borderRadius: 10,
// //     backgroundColor: '#eee', // Light gray background
...
//       )}
//       <View style={styles.serviceInfo}> {/* Added a container for text */}
//         <Text style={styles.serviceName}>{item.serviceName}</Text>
//         <Text style={styles.price}>{item.price} PKR</Text>
//         <Text style={styles.description}>{item.serviceDescription}</Text>
//       </View>
//       <TouchableOpacity
//         style={styles.bookNowButton}
//         onPress={() => navigation.navigate('BookService', { service: item, salon: salon })} // Pass service and salon
//       >
//         <Text style={styles.bookNowText}>Book Now</Text>
//       </TouchableOpacity>
//     </View>
...
//     shadowOpacity: 0.1,
//     shadowRadius: 5,
//     // alignItems: 'center', // Remove centering to align button
//   },
//   image: { width: '100%', height: 180, borderRadius: 10, resizeMode: 'cover', marginBottom: 10 }, // Added margin
//   imagePlaceholder: {
//     width: '100%',
//     height: 180,
//     borderRadius: 10,
...
//     marginBottom: 10,
//   },
//   serviceInfo: {  // Style for the text info
//     marginBottom: 10,
//   },
...
//   description: { fontSize: 14, color: '#00665C', marginTop: 8 },
//   emptyMessage: { textAlign: 'center', marginVertical: 20, fontSize: 16, color: '#777' },
//   bookNowButton: { // Style for the button
...
//     alignItems: 'center',
//   },
//   bookNowText: { // Style for the button text
//     color: 'white',
//     fontWeight: 'bold',
//     fontSize: 16,
//   },
