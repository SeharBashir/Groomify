...
const servicesList = [
  "Haircut", "Facial", "Manicure", "Pedicure", "Hair Coloring", "Waxing",
  "Makeup", "Threading", "Massage", "Beard Trim", "Hair Spa", "Scalp Treatment",
  "Keratin Treatment", "Shaving", "Eyebrow Shaping", "Bridal Makeup",
  "Groom Makeup", "Mehendi", "Nail Art", "Body Scrub", "Tanning",
...
const BeautyQuestionnaire = () => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      await AsyncStorage.setItem("userGender", gender); // Save gender in AsyncStorage
      Alert.alert("Preferences saved successfully!");
