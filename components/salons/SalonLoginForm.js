...
// // //         // ✅ All checks passed — navigate to SalonHomeScreen
// // //         navigation.navigate("SalonHomeScreen", { userId: user.uid });
// // //       } else {
// // //         // 👇 Instead of internal error, give clear message
// // //         Alert.alert(
// // //           "Salon Profile Missing",
// // //           "Salon profile not found in our system. Please recreate your salon profile or contact support."
// // //         );
// // //       }
// // //     } catch (error) {
// // //       const errorCode = error.code;
...
// // //         Object.keys(salons).forEach((key) => {
// // //           if (
// // //             salons[key].email === email.trim() &&
// // //             salons[key].salonName.toLowerCase() === salonName.toLowerCase()
// // //           ) {
// // //             found = true;
// // //           }
// // //         });
...
// // //     marginBottom: 40, borderColor: "#00665C", borderWidth: 4,
// // //   },
// // //   overlay: { alignItems: "center" },
// // //   image: {
// // //     width: "100%", height: "100%", borderBottomLeftRadius: 80, borderBottomRightRadius: 80, marginTop: 90,
// // //   },
// // //   welcomeText: { fontSize: 36, fontWeight: "900", color: "#FFFFFF", marginTop: 70, fontStyle: "italic" },
// // //   subtitle: { fontSize: 17, fontStyle: "italic", color: "#FFFFFF", marginTop: 20, marginBottom: 20 },
// // //   bottomContainer: { flex: 1, justifyContent: "center", alignItems: "center", paddingHorizontal: 20, marginTop: 70 },
// // //   inputContainer: { width: "90%", marginBottom: 15 },
// // //   iconInputWrapper: {
// // //     flexDirection: "row", alignItems: "center", backgroundColor: "white", borderRadius: 25,
// // //     paddingHorizontal: 15, borderWidth: 3, borderColor: "#00665C",
// // //   },
// // //   icon: { marginRight: 10 },
...
// // //     borderRadius: 25, marginBottom: 15, borderWidth: 1, borderColor: "#00665C",
// // //   },
// // //   actionButtons: { flexDirection: "row", alignItems: "center", marginTop: 10 },
// // //   forgotText: { color: "white", fontSize: 18 },
// // //   orText: { color: "white", marginHorizontal: 10, fontSize: 14 },
// // //   signupText: { color: "white", fontSize: 18 },
// // // });
...
// //       // Success — Navigate to salon home
// //       navigation.navigate("SalonHomeScreen", { userId: user.uid });
...
// //   orText: { color: "white", marginHorizontal: 10, fontSize: 14 },
// //   signupText: { color: "white", fontSize: 18 },
// //   buttonText: { color: "#00665C", fontSize: 18, fontWeight: "bold" },
// // });
...
// import {
//   StyleSheet, Text, TextInput, View, TouchableOpacity, Alert, Image,
//   ScrollView, KeyboardAvoidingView, TouchableWithoutFeedback, Keyboard, ActivityIndicator,
// } from "react-native";
// import { LinearGradient } from "expo-linear-gradient";
// import { signInWithEmailAndPassword, sendPasswordResetEmail } from "firebase/auth";
// import { ref, get } from "firebase/database";
...
//       // ✅ Check if salon exists and is approved
//       const salonRef = ref(db, `salons/${user.uid}`);
//       const snapshot = await get(salonRef);

//       if (!snapshot.exists()) {
//         setLoading(false);
//         Alert.alert("Access Denied", "No salon account found with this email.");
//         return;
//       }

//       const salonData = snapshot.val();
//       if (salonData.status !== "accepted") {
//         setLoading(false);
//         Alert.alert("Pending Approval", "Your salon account is not approved yet. Please wait for admin approval.");
//         return;
//       }
...
const SalonLoginForm = ({ navigation }) => {
  ...
  const handleLogin = async () => {
    ...
    try {
      const dbRef = ref(db, "salons");
      const snapshot = await get(dbRef);

      if (!snapshot.exists()) {
        setLoading(false);
        Alert.alert("Error", "No salons registered yet.");
        return;
      }
      ...
      // ✅ Search for matching salon by email + password
      Object.entries(salons).forEach(([id, salon]) => {
        // if (
        //   salon.email?.toLowerCase() === email.trim().toLowerCase() &&
  ...
  matchedSalonId = id;
      ...
      if (matchedSalon.status !== "accepted") {
        setLoading(false);
        Alert.alert("Pending Approval", "Your salon account is not yet approved by admin.");
        return;
      }

      // ✅ Success: Navigate to salon dashboard
      setLoading(false);
      navigation.navigate("SalonHomeScreen", { userId: matchedSalonId });
        ...
        <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
          <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
            ...
            <View style={styles.bottomContainer}>
              ...
              <View style={styles.actionButtons}>
                <TouchableOpacity onPress={() => Alert.alert("Contact Admin", "Please contact admin to reset your password.")}>
                  <Text style={styles.forgotText}>Forgot Password?</Text>
                </TouchableOpacity>
                <Text style={styles.orText}>|</Text>
                <TouchableOpacity onPress={() => navigation.navigate("SalonSignupScreen")}>
...
const styles = StyleSheet.create({
  ...
  overlay: { alignItems: "center", position: "absolute", top: 80 },
  image: {
    width: "100%", height: "100%", borderBottomLeftRadius: 80, borderBottomRightRadius: 80, marginTop: 90,
  },
  welcomeText: { fontSize: 36, fontWeight: "900", color: "#FFFFFF", marginTop: 70, fontStyle: "italic" },
