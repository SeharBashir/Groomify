...
//   // Fetch salon data for logged-in user
//   useEffect(() => {
//     if (user) {
//       const db = getDatabase();
//       const salonsRef = ref(db, "salons");
...
//             }))
//             .find((salon) => salon.ownerId === user.uid);
...
//     if (!salon || !salon.id) {
//       alert("Error: Salon data not found.");
//       return;
//     }
...
//       // Update salon data in database
//       const updatedData = {
//         salonName: serviceName,
//         ownerName: ownerName,
//         phoneNumber: phoneNumber,
//         salonLogo: logo,
//         password: password || salon.password,
//       };

//       console.log("Updating salon:", salon.id, updatedData);
...
//               {editable && (
//                 <>
//                   <TextInput style={styles.input} value={currentPassword} onChangeText={setCurrentPassword} placeholder="Current Password (for verification)" secureTextEntry />
